...
export default function Card({dayy, days}) {
  ...
  return (
    <div className="h-[370px] mt-12 p-3 rounded-3xl bg-bgCard ">
                <p className="w-4/5 p-3 rounded-lg text-xl text-white font-bold mt-2 mb-2 mx-auto text-center bg-bgNav">{dayy}</p>
                <div className={`test py-3 px-4 bg-bgTaske text-white rounded-b-3xl h-64 overflow-y-auto`}>
