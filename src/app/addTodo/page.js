...
export default function Page() {
    ...
    const saveWeek = () => {
        if (ref0.current.value === ""  || ref0.current.value <= numWeek || ref0.current.value % 1 != 0) {
        scroll({
            top: 0,
            behavior: "smooth",
        });
    ...
    return (
        ...
        <div className="w-full flex justify-center ">
            ...
            className="p-3 appearance-none bg-inherit focus:outline-white text-white font-bold rounded-md"
            />
        </div>
